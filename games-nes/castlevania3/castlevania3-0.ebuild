...
ROM_NAME="Castlevania III - Dracula's Curse"
MAIN_ROM_FILE="Castlevania III - Dracula's Curse (U) [!].nes"

DESCRIPTION="Nintendo Game: ${ROM_NAME}"
HOMEPAGE="https://romhustler.org/rom/nes/castlevania-iii-draculas-curse"
