...
ROM_NAME="Mappy"
MAIN_ROM_FILE='Mappy (J) [!].nes'

DESCRIPTION="Nintendo Game: ${ROM_NAME}"
HOMEPAGE="https://romhustler.org/rom/nes/mappy"
SRC_URI="http://dl.romhustler.net/download/hPob-3_ulsYwajglrY6qEg/1586065675/nes/Mappy.7z -> ${PN}.7z"
