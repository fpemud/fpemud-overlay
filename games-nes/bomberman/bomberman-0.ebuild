...
ROM_NAME="Bomberman"
MAIN_ROM_FILE='Bomberman (U).nes'

DESCRIPTION="Nintendo Game: ${ROM_NAME}"
HOMEPAGE="https://romhustler.org/rom/nes/bomberman"
SRC_URI="http://dl.romhustler.net/download/gkY90BCP1x1IoYjIr77Veg/1585931505/nes/Bomberman.7z"
