...
ROM_NAME="Teenage Mutant Ninja Turtles III - The Manhattan Project"
MAIN_ROM_FILE='Teenage Mutant Ninja Turtles III - The Manhattan Project (U).nes'

DESCRIPTION="Nintendo Game: ${ROM_NAME}"
HOMEPAGE="https://romhustler.org/rom/nes/teenage-mutant-ninja-turtles3"
