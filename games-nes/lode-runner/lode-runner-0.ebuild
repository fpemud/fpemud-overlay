...
ROM_NAME="Lode Runner"
MAIN_ROM_FILE='Lode Runner (U).nes'

DESCRIPTION="Nintendo Game: ${ROM_NAME}"
HOMEPAGE="https://romhustler.org/rom/nes/lode-runner"
SRC_URI="http://dl.romhustler.net/download/lf3QNRItMdNdJXAMa3UPgg/1586068528/nes/Lode%20Runner.7z -> ${PN}.7z"
