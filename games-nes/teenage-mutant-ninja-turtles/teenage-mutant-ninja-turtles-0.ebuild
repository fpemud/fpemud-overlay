...
ROM_NAME="Teenage Mutant Ninja Turtles"
MAIN_ROM_FILE='Teenage Mutant Ninja Turtles (U) [!].nes'

DESCRIPTION="Nintendo Game: ${ROM_NAME}"
HOMEPAGE="https://romhustler.org/rom/nes/teenage-mutant-ninja-turtles-1"
