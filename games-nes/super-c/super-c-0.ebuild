...
ROM_NAME="Super C"
MAIN_ROM_FILE='Super C (U) [!].nes'

DESCRIPTION="Nintendo Game: ${ROM_NAME}"
HOMEPAGE="https://romhustler.org/rom/nes/super-c"
SRC_URI="http://dl.romhustler.net/download/jEEsOsn3yHFFR_wTDaCjrQ/1586079867/nes/Super%20C.7z -> ${PN}.7z"
