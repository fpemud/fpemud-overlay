...
ROM_NAME="Metal Slug 4"

DESCRIPTION="MAME Game: ${ROM_NAME}"
HOMEPAGE="https://romhustler.org/rom/neogeo/metal-slug-4"
SRC_URI="http://dl.romhustler.net/download/jvOgDEooLv5rekuZLBXx0A/1586408914/neogeo/mslug4.zip"
