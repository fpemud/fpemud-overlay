...
RDEPEND="|| ( app-emulation/wine-vanilla[linguas_zh_CN]
              app-emulation/wine-d3d9[linguas_zh_CN]
              app-emulation/wine-staging[linguas_zh_CN]
              app-emulation/wine-any[linguas_zh_CN] )
